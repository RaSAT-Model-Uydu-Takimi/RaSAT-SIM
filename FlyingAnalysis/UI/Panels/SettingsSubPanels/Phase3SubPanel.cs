...
{
    public partial class Phase3SubPanel : UserControl
    {
        private bool _isSyncing = false;

        public Phase3SubPanel()
        {
            InitializeComponent();
            ...
            numWingClosedArea.ValueChanged += OnWingClosedAreaChanged;
        }
        ...
        private void LoadAndSync()
        {
            ...
            try
            {
                if ((decimal)GlobalSimulationConfig.WingClosedArea >= numWingClosedArea.Minimum &&
                    (decimal)GlobalSimulationConfig.WingClosedArea <= numWingClosedArea.Maximum)
                {
        ...
        private void OnWingClosedAreaChanged(object? sender, EventArgs e)
        {
        ...
        private void UpdateDynamicSummary()
        {
            ...
            double area = GlobalSimulationConfig.WingClosedArea;
            ...
            lblForceDiagramVisual.Text =
                ...
                $"┌────┴────┐\r\n" +
                $"│  GÖREV  │  (Taşıyıcı 550g Ayrıldı)\r\n" +
                $"│  YÜKÜ   │  A = {area:F4} m² (Kapalı Kanat)\r\n" +
                $"└────┬────┘  Cd = {cd:F2}\r\n" +
                $"     │\r\n" +
